...
setup   = [ Dev(4,1) Dev(3,1) Dev(5,1) Dev(1,1) Dev(6,1) Dev(2,1) Dev(2,1) Dev(6,1) Dev(1,1) Dev(5,1) Dev(3,1) Dev(4,1)] ;   
setupl  = [ Dev(4,2) Dev(3,2) Dev(5,2) Dev(1,2) Dev(6,2) Dev(2,2) Dev(2,2) Dev(6,2) Dev(1,2) Dev(5,2) Dev(3,2) Dev(4,2)] ;  
setupQf = [ Dev(4,3) Dev(3,3) Dev(5,3) Dev(1,3) Dev(6,3) Dev(2,3) Dev(2,3) Dev(6,3) Dev(1,3) Dev(5,3) Dev(3,3) Dev(4,3) ] ;   
setupR  = [ Dev(4,4) Dev(3,4) Dev(5,4) Dev(1,4) Dev(6,4) Dev(2,4) Dev(2,4) Dev(6,4) Dev(1,4) Dev(5,4) Dev(3,4) Dev(4,4) ] ;   
setupAng= [ Dev(4,5) Dev(3,5) Dev(5,5) Dev(1,5) Dev(6,5) Dev(2,5) Dev(2,5) Dev(6,5) Dev(1,5) Dev(5,5) Dev(3,5) Dev(4,5) ] ;   
